...
parentLoginForm.addEventListener("submit", (event) => {
  ...
  if (parent && parent.password !== password) {
    authMessage.textContent = "That password does not match this demo parent account.";
    return;
  }
...
parentChildForm.addEventListener("submit", (event) => {
  event.preventDefault();
  const parent = getCurrentParent();
...
academyManagement.addEventListener("click", (event) => {
